...
public class TeacherServiceImpl implements TeacherService {
  ...
  public TeacherDomain createTeacher(TeacherJson teacherJson) {
    ...
    var validEmail = teacherEmail.equalsIgnoreCase("gmail.com") || teacherEmail.equalsIgnoreCase("yahoo.com");
  ...
  public Page<TeacherDomain> getTeacher(Pageable page, String email) {
    ...
    if (Objects.nonNull(email)) {
      TeacherFilter teacherFilter = TeacherFilter.builder().email(email).build();
