...
public class TeacherController {
  ...
  @PostMapping
  public ResponseEntity<TeacherDomain> createTeacher(@Validated @RequestBody TeacherJson teacherJson) {
  ...
  @GetMapping
  public Page<TeacherDomain> getStudent(Pageable page, @RequestParam(name = "email", required = false) String email) {
