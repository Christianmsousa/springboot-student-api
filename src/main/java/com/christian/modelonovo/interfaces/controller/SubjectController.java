...
public class SubjectController {
  ...
  @PostMapping
  public ResponseEntity<SubjectDomain> createSubject(@RequestBody SubjectJson subjectJson) {
  ...
  @GetMapping
  public Page<SubjectDomain> getSubject(@RequestParam(name = "name", required = false) String name, Pageable page) {
