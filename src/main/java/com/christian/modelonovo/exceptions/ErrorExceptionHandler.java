...
public class ErrorExceptionHandler {
  ...
  public MessageError<MessageErrorList> alreadyRegisteredEnroll() {
    return new MessageError<MessageErrorList>(
      "Conflict",
      409,
      MessageErrorList.ALREADY_REGISTERED
    );
  }
  ...
  public MessageError<List<SimpleError>> notAllowed(
    MethodArgumentNotValidException e
  ) {
    return new MessageError<List<SimpleError>>(
      "Bad request",
      400,
      e
        .getBindingResult()
  ...
  public MessageError<MessageErrorList> pathError(
    HttpRequestMethodNotSupportedException e
  ) {
    return new MessageError<MessageErrorList>(
      "Bad request",
      400,
      MessageErrorList.METHOD_INVALID
    );
  }
}
